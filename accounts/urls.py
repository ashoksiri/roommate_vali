...
from .views import home,login_view,logout_view , register , profile , mail,analysis , get_access_token
...
urlpatterns = [
    ...
    # url(r'^accounts/get_access_token/$',get_access_token,name='get_access_token')
